    ...
    <div className="caroussel">
        ...
        <>
          <div className="caroussel-container">
            ...
            />
          <p className="img-counter">{`${currentId + 1}/${logementPictures.length}`}</p>
          <button className="previous-img" onClick={prevSlide}><img src={arrowSlider} alt="photographie précédente" /></button>
          <button className="next-img" onClick={nextSlide}><img src={arrowSlider} alt="prochaine photographie" /></button>
          </div>
        </>
        ) : (
            <div className="caroussel-container">
